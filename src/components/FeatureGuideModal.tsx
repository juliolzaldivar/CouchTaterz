...
export const FeatureGuideModal: React.FC<FeatureGuideModalProps> = ({
  ...
  const spotlightFeatures: SpotlightFeature[] = useMemo(() => [
    ...
    },
    {
      id: 'buddies',
      category: 'social',
      headline: 'Binge Buddies & Cross-Board Connections',
      subheadline: 'Peek at your friends’ live queues, borrow their top-rated shows, and send 1-click recommendations.',
      ...
      julioVerdict: "Stop texting 'What should I watch?' every Friday. Link up with your friends, check their ratings, and borrow their best finds in 2 seconds.",
      bulletPoints: [
        {
          icon: Users,
        ...
        },
        {
          ...
          description: 'Borrow any show from a buddy’s active rotation or trophy case directly into your own Backlog.',
          tag: 'Instant Clone'
        },
        {
          icon: Zap,
              ...
              {activeTab === 'avatar_studio' && (
                <div className="p-4 sm:p-5 rounded-3xl bg-slate-900 border border-slate-800 shadow-xl space-y-4">
                  ...
                  <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800 flex flex-col items-center justify-center space-y-3">
                    <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-blue-600/20 to-indigo-600/10 border-2 border-blue-500/30 flex flex-col items-center justify-center relative shadow-inner">
