...
export const DEFAULT_SHOWS: TvShow[] = [
  ...
  },
  {
    ...
    nextEpisode: {
      ...
      airDate: "2026-09-16",
      overview: "With Neagley's investigation into the suspicious death of her childhood friend hitting roadblocks, a buried secret from her past threatens to upend everything."
    },
    rottenTomatoesScore: 92,
    userScore: null,
    userNotes: "",
    overview: "Frances Neagley is a private investigator in Chicago and former military colleague of Jack Reacher in the Army's 110th Special Investigations Unit. When she learns that a beloved friend from her past has been killed in a suspicious accident, she becomes hell-bent on justice.",
    directors: ["Nick Santora", "Nicholas Wootton"],
    actors: ["Maria Sten", "Greyston Holt", "Adeline Rudolph", "Matthew Del Negro", "Damon Herriman"],
    bannerImage: "https://image.tmdb.org/t/p/original/uYOYLFQ4q7asuhdiKXCqGaeAQUH.jpg",
    ...
    episodes: {
      "S1E1": "L Train",
      "S1E2": "Team Building Exercises",
      "S1E3": "Hammer Time",
      "S1E4": "Breaking & Entering",
      "S1E5": "Trip",
      "S1E6": "Rocked",
      "S1E7": "Lebron's No Jordan",
      "S1E8": "Touched"
    },
    episodeReviews: {},
    createdAt: new Date().toISOString(),
